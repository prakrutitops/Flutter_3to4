...
class CategoryPage extends State<Category> {
  ...
  Future<List> viewCategoryItemsData() async{
    final responce = await http.get(Uri.parse("https://topsapi.000webhostapp.com/flutter_project_morning/Category_images/category_images_view.php?data="+category_id.toString()));
