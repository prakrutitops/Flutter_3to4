...
import '../../admin/front/admindashboard.dart';
...
class LoginPage extends State<Login>
{
  ...
  void check_if_already_login() async
  {
    ...
    adminuser = (logindata.getBool('adminlogin') ?? true);
    ...
    if(adminuser==false)
    {
        ...
        Navigator.pushReplacement(
            context, new MaterialPageRoute(builder: (context) => AdminDashBoard()));
  ...
  Future viewData() async {
    ...
    if(username.text.toString()=="admin" && password.text.toString()=="1234" && mobileno.text.toString()=="1234567890")
    {
      print("admin login done");
      logindata.setBool('adminlogin', false);
      logindata.setString('adminusername', username.text.toString());
